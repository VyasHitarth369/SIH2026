...
const roleTitles = {
  ...
  industry_employee: 'Industry Employee',
...
export default function ProfilePage() {
  ...
  } else if (user.role === 'university-admin' || user.role === 'university_admin') {
    const myUniversity = p.university;
  ...
  } else if (user.role === 'industry' || user.role === 'industry_employee') {
    extraSection = (
      <div className="card">
