    ...
    <div>
      ...
      {!loading && !error && mous.length === 0 && (
        <div className="card empty-state">
          ...
          <p>
            {lang === 'hi'
              ? 'वर्तमान में झारखंड सरकार के लिए कोई सक्रिय समझौता ज्ञापन (MOU) रिकॉर्ड उपलब्ध नहीं है।'
              : 'No active Memorandum of Understanding (MOU) records found for the Government portal.'}
          </p>
        </div>
      )}
      ...
      {/* TRIPARTITE MOU DOCUMENT VIEWER MODAL */}
      {viewingMOU && (
          ...
          <div className="card mou-printable-container" style={{ maxWidth: 840, width: '100%', background: '#fff', borderRadius: 12, padding: 32, maxHeight: '90vh', overflowY: 'auto' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                ...
                <button className="btn btn-sm btn-light" onClick={() => setViewingMOU(null)}>✕</button>
              </div>
            </div>
