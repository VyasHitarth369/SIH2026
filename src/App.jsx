...
const ALL_ROLES = ['citizen', 'student', 'faculty', 'university-admin', 'government', 'industry'];
...
export default function App() {
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute allowRoles={['university-admin']}><DashboardLayout /></ProtectedRoute>}>
      ...
      {/* Industry Employee */}
      <Route element={<ProtectedRoute allowRoles={['industry']}><DashboardLayout /></ProtectedRoute>}>
      ...
      {/* Shared across roles */}
      <Route element={<ProtectedRoute allowRoles={['student', 'industry']}><DashboardLayout /></ProtectedRoute>}>
